			...
			<div className="h-screen mx-4 mt-4">
				{loading ? (
					...
					{listingData.listing.title}
						...
						<h3 className="font-bold leading-10 mt-2 mb-4 text-xl">${listingData.listing.price}</h3>
					...
					<div className="flex flex-col">
						...
						<h2 className="font-semibold text-sm">@{listingData.seller.username}</h2>
					</div>{" "}
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 24 24"
